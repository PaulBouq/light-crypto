...
\part{Présentation de deux algorithmes de cryptographie légère}
	...
	et il a la particularité d’avoir été inclus au dernier standard international des méthodes de cryptographie légère par l’ « International Electrotechnical Commission » \cite{ultraLightURL}.
		...
		Pour plus de détails, la figure \ref{espacePhysique} présente pour différentes variantes de l’algorithme l’espace physique nécessaire en fonction de la technologie (NXP, UMC et NANGATE)\cite{googleSpongent} :
		...
		En comparaison, l’algorithme de hachage SHA-1 possède un débit de l’ordre d’ 1 Gbps \cite{SHA1}.
		...
		Enfin, la figure \ref{attaquePreImage} présente les résultats de sécurité face aux attaques par pré-image, par 2\up{ème} pré-image et par collision \cite{googleSpongent}.
